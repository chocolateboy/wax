...
The application version displayed in the output of the C<--version> option e.g.:
...
If set to true, the remote resource is saved to a persistent file. On subsequent
